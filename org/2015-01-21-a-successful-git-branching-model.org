...
Reposted from: http://nvie.com/posts/a-successful-git-branching-model/
...
<p class="centered"><img alt="" src="../assets/img/git-model@2x.png" width="575" /></p>
...
<p class="centered"><img alt="" src="../assets/img/centr-decentr@2x.png" width="487" /></p>
...
<p><img alt="" class="right" src="../assets/img/main-branches@2x.png" width="267" /></p>
...
<p><img alt="" class="right" src="../assets/img/fb@2x.png" width="133" /></p>
<dl>
...
<p class="centered"><img alt="" src="../assets/img/merge-without-ff@2x.png" width="478" /></p>
...
<p><img alt="" class="right" src="../assets/img/hotfix-branches@2x.png" width="316" /></p>
<dl>
<dt>May branch off from:</dt>
...
<p class="centered"><a href="http://nvie.com/files/Git-branching-model.pdf"><img alt="" src="../assets/img/pdf@2x.png" width="128" /></a><br />
<a href="/files/Git-branching-model.pdf">Git-branching-model.pdf</a></p>
  </div>


    <div class="flattr-btn">
      <script id='fbgcxfq'>(function(i){var f,s=document.getElementById(i);f=document.createElement('iframe');f.src='//api.flattr.com/button/view/?uid=nvie&button=compact&url=http%3A//nvie.com/posts/a-successful-git-branching-model/';f.title='Flattr';f.height=20;f.width=110;f.style.borderWidth=0;s.parentNode.insertBefore(f,s);})('fbgcxfq');</script>
    </div>
