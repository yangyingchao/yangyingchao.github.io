...
#+BEGIN_SRC ditaa :file images/mem2_allocation.png  :cmdline -r -s 1.5
  +-------+---------------------+--------------+-------------+-----------+
 ...
 * =mem=  \\
  ...
  #+BEGIN_SRC dot :file images/mem_2_mem.png :cmdline -Kdot -Tpng
    digraph Name {
 ...
 * =aiFreelist= \\
   List of free blocks
   #+BEGIN_SRC dot :file images/mem5_aiFreeList.png :cmdline -Kdot -Tpng
     digraph Name {
         node [fontsize=12 fontname=Courier style=filled shape=record];
         edge[color="#666666" style=dashed arrowhead=open tailclip=true];
         // rankdir=LR;
