...
* Callflow
#+BEGIN_SRC plantuml :file images/jit-callflow-gen.png
  |execExpr.c|
...
#+RESULTS:
[[file:images/jit-callflow-gen.png]]

* LLVM Jit Context
=llvm_session_initialize()=

#+BEGIN_SRC plantuml :file images/llvm_session_init-gen.png
  |llvm_session_initialize|
...
#+RESULTS:
[[file:images/llvm_session_init-gen.png]]
...
#+BEGIN_SRC plantuml :file images/exprstate-gen.png
...
#+NAME: fig:ExprState
#+RESULTS:
[[file:images/exprstate-gen.png]]

步骤如下：

#+BEGIN_SRC plantuml :file images/do-create-function-gen.png
  |do_compile|
  :prepare function;
  |prepare|
...
#+RESULTS:
[[file:images/do-create-function-gen.png]]

* Inline

减少函数调用开销。

#+BEGIN_SRC plantuml :file images/inline-gen.png
  |llvm_inline|
...
#+BEGIN_SRC plantuml :file images/llvm-optimization-gen.png
...
#+RESULTS:
[[file:images/llvm-optimization-gen.png]]
...
#+BEGIN_SRC plantuml :file images/llvm-pass-managers-gen.png
...
#+RESULTS:
[[file:images/llvm-pass-managers-gen.png]]
