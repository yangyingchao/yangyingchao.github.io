...
#+BEGIN_SRC plantuml :file images/xlog-insert-general-flow-gen.png
  |CALLER|
  :XLogBeginInsert();
...
#+RESULTS:
[[file:images/xlog-insert-general-flow-gen.png]]
...
#+BEGIN_SRC plantuml :file images/xlog-insert-flow-gen.png
  |heamam|
...
#+END_SRC
#+RESULTS:
[[file:images/xlog-insert-flow-gen.png]]


** Data Structures

#+BEGIN_SRC plantuml :file images/xl-ds-gen.png
  class XLogRecData {
      + XLogRecData* next
      + char* data
      + uint32 len
