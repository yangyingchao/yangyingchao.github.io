...
#+BEGIN_SRC ditaa :file images/xact-layers-gen.png  :cmdline -r -s 1.5
      +--------------------------------+-------------+
...
#+RESULTS:
[[file:images/xact-layers-gen.png]]



* Data Structures

#+BEGIN_SRC plantuml :file images/xact-ds-gen.png
...
#+BEGIN_SRC plantuml :file images/begin-xcat-flow-gen.png
  |postgres.c|
  start
  :PostgresMain();
...
#+NAME: fig:BEGIN
#+RESULTS:
[[file:images/begin-xcat-flow-gen.png]]
...
#+BEGIN_SRC plantuml :file images/StartTransactionCommand-gen.png
...
#+RESULTS:
[[file:images/CommitTransactionCommand-gen.png]]
...
#+BEGIN_SRC plantuml :file images/select-xcat-flow-gen.png
  |postgres.c|
...
#+NAME: fig:SELECT
#+RESULTS:
[[file:images/select-xcat-flow-gen.png]]
